	...
	modules_list{ { 8, 365, 99, 500 },  SDL_Color{ 125, 125 , 125, 255 }, 100, 20, 5 }
{
	...
	menu_options = {
		BButton_ptr{ new Button{ "data/local_menus/Options/SAVE.png", &Menu_options::button_Save } },
		BButton_ptr{ new Button_input{ "data/local_menus/Options/SAVE_AS.png", "SAVE LEVEL AS:", &Menu_options::button_SaveAs } },
		BButton_ptr{ new Button_input{ "data/local_menus/Options/LOAD.png", "LOAD LEVEL:", &Menu_options::button_Load, "Level doesn't exist!" } },
		BButton_ptr{ new Button{ "data/local_menus/Options/EXIT.png", &Menu_options::button_Exit } }
	};

	modules_list = {
		BButton_ptr{ new Button{ "data/menus scrollbar/dynamic_objectsPlacer module.png" } },
		BButton_ptr{ new Button{ "data/menus scrollbar/block_placer module.png" } },
...
void Bar_modules_left::reset_states()
{
	menu_options.set_active(true);
	modules_list.reset();
}
