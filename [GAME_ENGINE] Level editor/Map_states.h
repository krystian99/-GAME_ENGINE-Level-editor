...
enum class Map_state { NONE, PLACING_OBJECTS, MOVING_MAP, MOVING_OBJECT, UPDATE_MULTI_MOVE_OBJ, MULTI_MOVING_OBJECTS, SELECTING_OBJECTS, MULTI_SELECTING_OBJECTS_STARTED, SELECTING_OBJECTS_FINISHED, DELETE_OBJECTS };
