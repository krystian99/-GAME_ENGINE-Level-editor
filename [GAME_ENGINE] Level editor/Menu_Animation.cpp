...
void Menu_Animation::events_indp()
{
	...
	if (newConfig.is_mouseKey_1hit(Mouse_key::L_BUTTON) && !input_animName.is_empty() && !input_amountOf_frames.is_empty()) {
	...
	else if (loadConfig.is_mouseKey_1hit(Mouse_key::L_BUTTON) && !input_animName.is_empty()) {
