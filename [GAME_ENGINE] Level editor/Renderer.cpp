...
void Renderer::Init()
{
	...
	if (!(window = SDL_CreateWindow("Game Engine", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, Video_Info::getWindow_W(), Video_Info::getWindow_H(), SDL_WINDOW_SHOWN)))
