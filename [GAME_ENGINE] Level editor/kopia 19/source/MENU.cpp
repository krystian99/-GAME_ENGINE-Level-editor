...
void MENU::Init(const SDL_DisplayMode * dsp, const double & scaleW, const double & scaleH)
{
	mSet_Start(dsp, scaleW, scaleH);
}
...
void MENU::mSet_Start(const SDL_DisplayMode * dsp, const double & scaleW, const double & scaleH)
{
