...
class OBJ_TEST {
public:
	OBJ_TEST(const int & x1, const int & y1, const double & scaleX, const double & scaleY);
...
private:
	...
	const double renderScaleX, renderScaleY;
...
private:
	...
	void createOBJ(int mX, int mY, const double & scaleX, const double & scaleY);
