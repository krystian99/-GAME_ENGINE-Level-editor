...
Coordinates_bar::Coordinates_bar(const SDL_Rect & pos)
{
	...
	text_to_render = std::unique_ptr<Text>{ new Text{ pos.x + 50, pos.y + 10, "data/fonts/standard_font.ttf", 20,{ 255 } } };
...
void Coordinates_bar::set(const SDL_Rect * rt, const SDL_Rect * ru)
{
	state = CoordinateBar_state::OTHER;
	cord = rt;
	cord2 = ru;
