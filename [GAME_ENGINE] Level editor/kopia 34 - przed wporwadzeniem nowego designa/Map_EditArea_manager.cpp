...
void Map_EditArea_manager::set_temp_renderOBJ()
{
	...
	case OBJ_type::ENEMY:
		...
		case Enemy_ID::TEST:
			temp_renderOBJ.w = Enemy_Test::W;
			temp_renderOBJ.h = Enemy_Test::H;
			break;
		case Enemy_ID::TEST2:
			temp_renderOBJ.w = Enemy_Test2::W;
			temp_renderOBJ.h = Enemy_Test2::H;
			break;
		case Enemy_ID::TEST3:
			temp_renderOBJ.w = Enemy_Test3::W;
			temp_renderOBJ.h = Enemy_Test3::H;
			break;
		}
