...
{
	Init();
	sbStatic.SetPOSition({ 0, 100, 100, Setup::getDisplayHeight() - 200 });
	sbDynamic.SetPOSition({ Setup::getDisplayWidth() - 100, 100, 100, Setup::getDisplayHeight() - 200 });
	sbKey.SetPOSition({ 100 , 0, Setup::getDisplayWidth() - 200, 100 });
	start_render();
}
