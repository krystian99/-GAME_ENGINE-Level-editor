...
private:
	...
	static const int MOVE_SIZE = 20; // o ile pixeli maj¹ przesuwaæ siê przyciski
	static const int FRAME_SIZE = 5; // iloœæ pixeli odstêpu miêdzy pocz¹tkiem scrollbara, a koñcem scrollbara
