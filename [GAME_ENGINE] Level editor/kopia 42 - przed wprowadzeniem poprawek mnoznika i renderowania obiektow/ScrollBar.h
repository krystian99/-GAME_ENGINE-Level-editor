...
public:
	...
	ScrollBar(const SDL_Rect & pos, const std::string & texture, int size_expand); // ustala automatycznie orientacjê
	ScrollBar(const SDL_Rect & pos, const SDL_Color & color, int size_expand); // ustala automatycznie orientacjê
