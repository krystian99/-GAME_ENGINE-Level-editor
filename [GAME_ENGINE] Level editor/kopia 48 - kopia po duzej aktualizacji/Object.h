...
public:
	...
	void events(); // nie ma potrzeby ustawiaonia tej funkcji jako wirtualnej, bo klasa ta nie bêdzie s³u¿y³a jako interfejs bazowy -> jednak, by dzia³a³y funkcje tutaj zawarte, musi byæ wywo³ana ta metoda w klasie pochodnej
