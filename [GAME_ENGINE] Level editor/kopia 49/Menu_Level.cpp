...
void Menu_Level::events_indp()
{
	...
	if (New.is_mouseKey_1hit(Mouse_key::L_BUTTON) && !input_levelname.is_empty() && !input_background.is_empty()) {
	...
	else if (Load.is_mouseKey_1hit(Mouse_key::L_BUTTON) && !input_levelname.is_empty()) {
