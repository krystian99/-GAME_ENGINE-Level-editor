...
#include "Interact_OBJ.h" // umieszczanie przedmiotów, za pomoc¹ których wchodzimy w ró¿ne interakcje
...
private:
	...
	void blockPlacerModule_events(); // 
	void dynamicOBJ_module_events();
	void interactOBJ_module_events();
...
private:
	...
	BlockPlacer_module blockPlacer_module; // zamkniêty interfejs, ¿eby zwiêkszyæ czytelnoœæ kodu
