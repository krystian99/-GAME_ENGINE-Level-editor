...
void Enemies_placer::placing_object_events(int map_x, int map_y, int render_x, int render_y)
{
	...
	{
	case Enemy_ID::TEST:
		enemies.push_back(new Enemy_Test{ map_x, map_y, flip });
		break;
	case Enemy_ID::TEST2:
		enemies.push_back(new Enemy_Test2{ map_x, map_y, flip });
		break;
	case Enemy_ID::TEST3:
		enemies.push_back(new Enemy_Test3{ map_x, map_y, flip });
		break;
	case Enemy_ID::TEST4:
		enemies.push_back(new Enemy_Test4{ map_x, map_y, flip });
		break;
	}
