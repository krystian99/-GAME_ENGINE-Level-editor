...
void Script::entering_events(std::vector<Button*> & buttons)
...
void Script::leaving_events(std::vector<Button*> & buttons)
...
void Script::events_buttons(std::vector<Button*> & buttons)
{
	switch (script_state) {
...
void Script::render_buttons(std::vector<Button*> & buttons, const int & render_fromY) // cos podobnego do skryptu domyslnei wgranego w ScrollBar'u
{
...
void Script::move_buttons(std::vector<Button*>& buttons, int size)
{
	for (auto & button : buttons)
